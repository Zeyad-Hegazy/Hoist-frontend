...
// 											<p className="flex justify-center items-center p-4 w-2 h-2 rounded-full bg-blue-600 text-white">
// 												<FontAwesomeIcon icon={faEye} />
// 											</p>
// 											<p className="flex justify-center items-center p-4 w-2 h-2 rounded-full bg-yellow-500 text-white">
...
// 												<DeleteDialog
// 													setStateClose={handleClickClose}
// 													state={open}
// 													id={row._id}
